/*
  ...
  - Testing comms between PC-based java program and Arduino - using Ardulink (see http://www.ardulink.org/)
  - Version 1a : Basic LED blinking (basic ardulink library only)
*/
